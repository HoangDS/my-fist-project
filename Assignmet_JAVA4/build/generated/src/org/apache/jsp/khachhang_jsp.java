...
public final class khachhang_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 KhachHangDAO nvDAO = new KhachHangDAO();
      ...
      out.write("                    <h3><a style=\"color: #050505; margin-left: 10px\" href=\"#\">Thống kê đặt hàng</a></h3>\n");
      ...
      out.write("                        <form action=\"KHServlet\" method=\"post\">\n");
      ...
      out.write("                            <tr>\n");
      out.write("                                <td>");
      out.print(nvDAO.getAllKhachHang().get(i).getMaKH());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(nvDAO.getAllKhachHang().get(i).getTenKH());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(nvDAO.getAllKhachHang().get(i).getDiaChi());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(nvDAO.getAllKhachHang().get(i).getEmail());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(nvDAO.getAllKhachHang().get(i).getSoDienThoai());
      out.write("</td>\n");
      out.write("                                <td>\n");
      out.write("                                    <a href='");
      out.print("KHServlet?action=edit&MaKH=" + nvDAO.getAllKhachHang().get(i).getMaKH());
      out.write("'><i class=\"fa fa-pencil\" aria-hidden=\"true\"></i>Edit</a>|\n");
      out.write("                                    <a href='");
      out.print("KHServlet?action=del&MaKH=" + nvDAO.getAllKhachHang().get(i).getMaKH());
