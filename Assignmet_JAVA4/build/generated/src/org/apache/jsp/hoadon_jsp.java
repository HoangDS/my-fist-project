...
public final class hoadon_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 HoaDonDAO hdDAO = new HoaDonDAO();
      ...
      out.write("                                <input type=\"text\" class=\"form-control\" placeholder=\" Mời nhập mã khách hàng\" name=\"MaHD\" value=\"");
      ...
      out.write("                            <input type=\"text\" class=\"form-control\" placeholder=\"Mời nhập tên khách hàng\" name=\"MaKH\" value=\"");
      ...
      out.write("                            <input type=\"text\" class=\"form-control\" placeholder=\"Mời nhập địa chỉ khách hàng\" name=\"NgayLap\" value=\"");
      ...
      out.write("                            <input type=\"number\" class=\"form-control\" placeholder=\"Mời nhập Email khách hàng\" name=\"TongTien\" value=\"");
      ...
      out.write("                            <input type=\"text\" class=\"form-control\" placeholder=\"Mời nhập số điện thoại khách hàng\" name=\"Ghichu\" value=\"");
      ...
      out.write("                            <tr>\n");
      out.write("                                <td>");
      out.print(hdDAO.getAllHoaDon().get(i).getMaHD());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(hdDAO.getAllHoaDon().get(i).getMaKH());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(hdDAO.getAllHoaDon().get(i).getNgayLap());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(hdDAO.getAllHoaDon().get(i).getTongTien());
      out.write("</td>\n");
      out.write("                                <td>");
      out.print(hdDAO.getAllHoaDon().get(i).getGhiChu());
      out.write("</td>\n");
      out.write("                                <td>\n");
      out.write("                                    <a href='");
      out.print("HoadonServlet?action=edit&MaHD=" + hdDAO.getAllHoaDon().get(i).getMaHD());
      out.write("'><i class=\"fa fa-pencil\" aria-hidden=\"true\"></i>Edit</a>|\n");
      out.write("                                    <a href='");
      out.print("HoadonServlet?action=del&MaHD=" + hdDAO.getAllHoaDon().get(i).getMaHD());
