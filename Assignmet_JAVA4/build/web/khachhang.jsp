<%-- 
    Document   : khachhang
    Created on : Oct 25, 2017, 8:28:38 AM
    Author     : dell-lt
--%>
            ...
            <div id="container">
                ...
                <div id="content-right" style="width: 75%">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <%
                                for (int i = 0; i < nvDAO.getAllKhachHang().size(); i++) {
                            %>
                            <tr>
                                <td><%=nvDAO.getAllKhachHang().get(i).getMaKH()%></td>
                                <td><%=nvDAO.getAllKhachHang().get(i).getTenKH()%></td>
                                <td><%=nvDAO.getAllKhachHang().get(i).getDiaChi()%></td>
                                <td><%=nvDAO.getAllKhachHang().get(i).getEmail()%></td>
                                <td><%=nvDAO.getAllKhachHang().get(i).getSoDienThoai()%></td>
                                <td>
                                    <a href='<%="KHServlet?action=edit&MaKH=" + nvDAO.getAllKhachHang().get(i).getMaKH()%>'><i class="fa fa-pencil" aria-hidden="true"></i>Edit</a>|
                                    <a href='<%="KHServlet?action=del&MaKH=" + nvDAO.getAllKhachHang().get(i).getMaKH()%>'><i class="fa fa-trash" aria-hidden="true"></i>Del</a>
                                </td>
                            </tr>
                            <%}%>
                        </tbody>
