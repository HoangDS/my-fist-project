            ...
            switch (action) {
                ...
                case "add":
                    ...
                    if (ss.getAttribute("USERNAME") != null) {
                        KhachHang nv = new KhachHang(MaKH, TenKH, DiaChi, Email, Integer.parseInt(SoDienThoai));
                        nvDAO.addKhachHang(nv);
                        request.setAttribute("LIST_KHACHHANG", nvDAO.getAllKhachHang());
                ...
                case "edit":
                    ...
                    if (ss1.getAttribute("USERNAME") != null) {
                        request.setAttribute("LIST_KHACHHANG", nvDAO.getAllKhachHang());
                        Vector a = nvDAO.getKhachHang(MaKH);
                ...
                case "update":
                    ...
                    if (ss2.getAttribute("USERNAME") != null) {
                        KhachHang nv1 = new KhachHang(MaKH, TenKH, DiaChi, Email, Integer.parseInt(SoDienThoai));
                        if (nvDAO.updateKhachHang(nv1) == 1) {
                            request.setAttribute("LIST_KHACHHANG", nvDAO.getAllKhachHang());
                            request.getRequestDispatcher("khachhang.jsp").forward(request, response);
                        }
                        break;
